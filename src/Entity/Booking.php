...
class Booking
{
     ...
     * @ORM\Column(type="datetime")
     * @Assert\Date(message = "La date doit être au bon format")
     * @Assert\GreaterThan(propertyPath = "startDate", message = "La date de départ doit être plus grande que celle d'arrivée")
     */
    private $endDate;
    ...
    public function isBookablaDates()
    {
     ...
     *
     * @return array Un tableau d'objets DateTime représantant les jours de la réservation
     */
