 ...
 *  * @UniqueEntity(
 *     fields={"email"},
 *     message="Adresse email déjà prise"
 * )
 */
class User implements UserInterface
{
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\NotBlank(message = "Merci de rentrer votre nom de famille")
     */
    private $lastName;
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\Length(min = 10, minMessage = "Votre introduction doit faire minimum 10 caractères")
     */
    private $introduction;

    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min = 100, minMessage = "Votre description doit faire minimum 100 caractères")
     */
    private $description;
